...
This is a simple example of a data source that returns a black square 100x100 96dpi RGB24. You can download full code of a [SampleDataSource.cs](../download/Minimal.cs).
